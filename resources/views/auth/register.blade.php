                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="role_id"
                                    class="col-md-4 col-form-label text-md-start">{{ __('Grupo de Permissões') }}</label>
                                <select name="role_id" id="role_id" class="block mt-2 w-50 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                            ...
                            <div class="row my-0">
                                <div class="col-md-6 offset-md-4 text-md-end my-2">
